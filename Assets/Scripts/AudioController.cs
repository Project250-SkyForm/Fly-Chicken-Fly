...
public class AudioController : MonoBehaviour
{
    ...
    public float hitVolume, jumpVolume, grassWalkVolume, cloudWalkVolume, landVolume, obstacleFallVolume, barkVolume;
    ...
    public void PlayAmbientSounds(){
        backgroundMusicSource.volume = barkVolume;
        backgroundMusicSource.PlayOneShot(ambientSounds[Random.Range(0, ambientSounds.Length)]);
        playRandomSound();
    }
